...
export const Restaurants = [
  ...
  },
  {
    ...
    name: 'NewMan Hotel',
    description: 'A restaurant is a business that prepares and serves food and drinks to customers. Meals are generally served and eaten on the premises',
    icon: require('../assets/home_main/home/dailyS2.jpg'),
    dineIn: false,
    takeAway: false,
    homeDelivery: true,
    images: [
      require('../assets/home_main/home/dailyS1.jpg'),
      require('../assets/home_main/home/res.png'),
      require('../assets/home_main/home/salan.png'),
    ],
    menu: [
    ...
    foodCategory: [
      {
        ...
        items: [
          {
            resId: 'Resturant2', resName: 'NewMan Hotel',
            price: '300',
            description: 'a flat round mass of minced meat or vegetables, which is fried and often eaten in a bread roll.',
            id: 'Resturant2Pizza1',
            name: 'Beaf Burger1',
